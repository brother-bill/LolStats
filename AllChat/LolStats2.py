...
apiKey = "RGAPI-84fc2449-345f-4ce1-a18e-aad18326ec5b"  # Get API key here: https://developer.riotgames.com/

# List of queue types found here: http://static.developer.riotgames.com/docs/lol/queues.json
gameType = 450  # 450 is Aram, 440 is Ranked Flex, 430 is Norms, 420 is Solo/Duo Ranked, 400 is Draft, 0 is Customs

# Table of champions for each username to find stats on, None finds all games in gametype regardless of champion
table = {
    "PUT USERNAME HERE": ["Trundle", "Akali"],
}
my_region = "na1"
