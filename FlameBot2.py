...
# This failsafe prevents the chat from disabling if your mouse reaches the corner of the screen
...
# This is max number of games to search for each player
maxCount = 10

# The parameter changes the typed string to all chat so you can update per gamemode
greeting("ARAM")
...
try:
    ...
    for stat in statsList:
        print(stat + "\n")
        allChat(stat)
    allChat("LIKE COMMENT AND SUBSCRIBE")
except ApiError as err:
